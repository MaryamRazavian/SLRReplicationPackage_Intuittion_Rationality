...
Note: a full overview in one file is available in .xslx format [here](XLSX/Replication Package  When Rationality Meets Intuition A Research Agenda for Software Design Decision Making.xlsx)
## Abstract 
