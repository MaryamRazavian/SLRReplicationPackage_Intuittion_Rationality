...
The replication package comprises multiple files that are accessible in both .xlsx (downloadable) and .csv (Github preview) formats. It is structured as given below, all files are accessible through Github. 
